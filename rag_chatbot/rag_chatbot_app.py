...
st.set_page_config(page_title="RAG Chatbot TEST") #HTML title
st.title("RAG Chatbot TEST") #page title
...
if input_text: #run the code in this if block after the user submits a chat message
    ...
    with st.chat_message("assistant"): #display a bot chat message
        st.markdown(chat_response, unsafe_allow_html=True) #display bot's latest response
